...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        <div class="sidenav-header text-center">
            ...
            <span class="navbar-brand">
                ...
                <span class="ms-1 font-weight-bold text-white">Hospital Infantil</span>
            </span>
        </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    {{-- <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Hospital
                                Infantil</a>
                        </li>
        ...
        <div class="container-fluid py-4">
            ...
            <footer class="footer py-4" hidden="true">
    ...
    <div class="fixed-plugin" hidden="true">
